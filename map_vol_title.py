...
if __name__ == "__main__":
    ...
    # pedurma_vol_mapping = yaml.safe_dump(peduma_vols, sort_keys=False, allow_unicode=True)
    # Path('./pedurma_vol_mapping.yml').write_text(pedurma_vol_mapping, encoding='utf-8')
